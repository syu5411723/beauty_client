...
import { ShaderMaterial, PlaneBufferGeometry, Mesh, Scene, OrthographicCamera, WebGLRenderer, Vector4, ImageBitmapLoader, } from 'three';
...
var DistortionEffectCarouselPlugin = /** @class */ (function () {
    function DistortionEffectCarouselPlugin(_a) {
        ...
        this.images = images.map(function (_, index) { return new ImageWrapper({ isDisplacement: false, index: index }); });
        ...
        var mesh = new Mesh(this.geometry, this.mat);
    ...
    DistortionEffectCarouselPlugin.prototype.loadImage = function (src, imageWrapper) {
        ...
        this.loader.load(src, function (image) {
            ...
            var textureWrapper = find(_this.textures, { isDisplacement: isDisplacement, index: index });
            if (textureWrapper) {
    ...
    DistortionEffectCarouselPlugin.prototype.createVector = function () {
        return new Vector4(this.width * (this.dpr / 2), this.height * (this.dpr / 2), 1, 1);
    };
    DistortionEffectCarouselPlugin.prototype.drawImage = function (_a) {
        ...
        switch (backgroundSize) {
            ...
            default: {
                var scaleFunction = backgroundSize === 'cover' ? cover : contain;
...
export { DistortionEffectCarouselPlugin };
